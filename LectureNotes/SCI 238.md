...
rocky leftovers of planet formatino 

largest is ceres 1000 kilometers now as a dwarf planet

over a million with diameter > 1 km

asteroids are NOT ROund 

most are between mars and jupiter 

trojan asteroids follow jupiter's orbit 

meteor is the bright trail left by meterorite 

meteroite the small rock from space that falls through Earth's atmosphere 

comets are formed beyond frost line 

Necleus of a comet is a dirty snowball 

no tails for most comets 
...
LaGrange points for Euclid satellite 
...
resulting eclipse reduces the star's apparent brightness and tells us planet's radius 

how much the light is reduced depends on the size 

so you can calculate the amount of light decreased based on luminosity formula
